        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview active">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="active" ><a href="/brigady/index.php/kriteria"><i class="fa fa-circle-o"></i>Kritéria</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
            ...
            <div class="col-md-12">
                <div class="box box-warning">
                    <div class="box-header">
                        <h3 class="panel-heading">Kritéria<a href="<?php echo
                            site_url('kriteria/add/'); ?>" class="glyphicon glyphicon-plus pull-right" style="color: #f39c12"></a></h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                                <th width="5%">ID</th>
                                <th width="30%">Názov brigády</th>
                                <th width="30%">Potrebná zručnosť</th>
                                <th width="35%">Funkcie</th>
                            </tr>
                            </thead>
                            <tbody id="userData">
                            <?php if (!empty($kriteria)): foreach ($kriteria as $kriterium): ?>
                                <tr>
                                    <td><?php echo '#' . $kriterium['id_kriteria']; ?></td>
                                    <td><?php echo $kriterium['brNazov']; ?></td>
                                    <td><?php echo $kriterium['zrNazov']; ?></td>
                                    <td>
                                        <a href="<?php echo
                                        site_url('kriteria/view/' . $kriterium['id_kriteria']); ?>"
                                           class="glyphicon glyphicon-eye-open" style="color: #f39c12"></a>
                                        <a href="<?php echo
                                        site_url('kriteria/edit/' . $kriterium['id_kriteria']); ?>"
                                           class="glyphicon glyphicon-edit" style="color: #f39c12"></a>
                                        <a href="<?php echo
                                        site_url('kriteria/delete/' . $kriterium['id_kriteria']); ?>"
