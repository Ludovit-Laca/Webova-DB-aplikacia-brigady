...
<div class="register-box">
    <div class="register-logo">
        <a href="../../index2.html"><b>Brigady</b>Laca</a>
    </div>

    <div class="register-box-body">
        <p class="login-box-msg">Zaregistrujte sa</p>

        <form action="<?php echo base_url(); ?>index.php/home/register_validation" method="post">
            <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="Užívateľské meno" name="username">
            ...
            <div class="row">
                <!-- /.col -->
                <div class="col-xs-12">
                    <button type="submit" name="insert" class="btn btn-primary btn-block btn-flat">Registrovať</button><br>
                </div>
                <!-- /.col -->
            </div>
        </form>

        <a href="login" class="text-center">Už som zaregistrovaný</a>
