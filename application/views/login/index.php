...
<div class="login-box">
    ...
    <div class="login-box-body">
        <p class="login-box-msg">Prihláste sa</p>

        <form method="post" action="<?php echo base_url(); ?>index.php/home/login_validation">
            ...
            <div class="row">
                <!-- /.col -->
                <div class="col-xs-4">
                    <button type="submit" name="insert" value="Login" class="btn btn-primary btn-block btn-flat">Sign
                        In
                    </button>
                </div>
