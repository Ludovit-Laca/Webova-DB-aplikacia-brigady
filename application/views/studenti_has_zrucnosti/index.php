        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview active">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="active"><a href="/brigady/index.php/studenti_has_zrucnosti"><i
                                    class="fa fa-circle-o"></i>Zručnosti študentov</a></li>
            ...
            <div class="col-md-12">
                <div class="box box-warning">
                    <div class="box-header">
                        <h3 class="panel-heading">Zručnosti študentov<a href="<?php echo
                            site_url('studenti_has_zrucnosti/add/'); ?>" class="glyphicon glyphicon-plus pull-right"
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                                <th width="5%">ID</th>
                                <th width="30%">Meno študenta</th>
                                <th width="30%">Zručnosť študenta</th>
                                <th width="35%">Funkcie</th>
                            </tr>
                            </thead>
                            <tbody id="userData">
                            <?php if (!empty($studenti_has_zrucnosti)): foreach ($studenti_has_zrucnosti as $student_zrucnost): ?>
                                <tr>
                                    <td><?php echo '#' . $student_zrucnost['id_študenti_has_zručnosti']; ?></td>
                                    <td><?php echo $student_zrucnost['fullname']; ?></td>
                                    <td><?php echo $student_zrucnost['zrNazov']; ?></td>
                                    <td>
                                        <a href="<?php echo
                                        site_url('studenti_has_zrucnosti/view/' . $student_zrucnost['id_študenti_has_zručnosti']); ?>"
                                           class="glyphicon glyphicon-eye-open" style="color: #f39c12"></a>
                                        <a href="<?php echo
                                        site_url('studenti_has_zrucnosti/edit/' . $student_zrucnost['id_študenti_has_zručnosti']); ?>"
                                           class="glyphicon glyphicon-edit" style="color: #f39c12"></a>
                                        <a href="<?php echo
                                        site_url('studenti_has_zrucnosti/delete/' . $student_zrucnost['id_študenti_has_zručnosti']); ?>"
