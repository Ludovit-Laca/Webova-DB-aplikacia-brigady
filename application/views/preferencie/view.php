            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="box box-warning">
                        <div class="panel-heading">Detaily preferencie študenta<a href="<?php
                            echo site_url('preferencie/'); ?>" class="glyphicon glyphicon-arrow-left
pull-right" style="color: #f39c12"></a></div>
                        <div class="panel-body">
                            <div class="form-group">
                                <label>Meno študenta:</label>
                                <p><?php echo !empty($preferencie['fullname']) ? $preferencie['fullname'] : ''; ?></p>
                            </div>
                            <div class="form-group">
                                <label>Typ brigády:</label>
                                <p><?php echo !empty($preferencie['nazov']) ? $preferencie['nazov'] : ''; ?> </p>
                            </div>
                        </div>
                    </div>
                </div>
