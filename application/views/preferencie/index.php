            ...
            <li class="treeview active">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="/brigady/index.php/studenti_has_brigady"><i class="fa fa-circle-o"></i>Brigády
                            študentov</a></li>
                    <li class="active"><a href="/brigady/index.php/preferencie"><i class="fa fa-circle-o"></i>Preferencie
                            študentov</a></li>
            ...
            <div class="col-md-12">
                <div class="box box-warning">
                    <div class="box-header">
                        <h3 class="panel-heading">Preferencie študentov
                            <a href="<?php echo
                            site_url('preferencie/add/'); ?>" class="glyphicon glyphicon-plus pull-right"
