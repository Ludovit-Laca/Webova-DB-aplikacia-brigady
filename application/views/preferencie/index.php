        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview active">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="active"><a href="/brigady/index.php/preferencie"><i class="fa fa-circle-o"></i>Preferencie študentov</a></li>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Tabuľka
            <small>Preferencie študentov</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-table"></i>Domov</a></li>
            <li><a href="#">Tabuľky</a></li>
            <li class="active">Preferencie študentov</li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-12">
                <div class="box box-warning">
                    <div class="box-header">
                        <h3 class="panel-heading">Preferencie študentov <a href="<?php echo
                            site_url('preferencie/add/'); ?>" class="glyphicon glyphicon-plus pull-right" style="color: #f39c12"></a></h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th width="30%">Typ brigády</th>
                                <th width="35%">Funkcie</th>
                            </tr>
                            </thead>
                            <tbody id="userData">
                            <?php if (!empty($preferencie)): foreach ($preferencie as $preferencia): ?>
                                <tr>
                                    <td><?php echo '#' . $preferencia['id_preferencie']; ?></td>
                                    <td><?php echo $preferencia['fullname']; ?></td>
                                    <td><?php echo $preferencia['nazov']; ?></td>
                                    <td>
                                        <a href="<?php echo
                                        site_url('preferencie/view/' . $preferencia['id_preferencie']); ?>"
                                           class="glyphicon glyphicon-eye-open" style="color: #f39c12"></a>
                                        <a href="<?php echo
                                        site_url('preferencie/edit/' . $preferencia['id_preferencie']); ?>"
                                           class="glyphicon glyphicon-edit" style="color: #f39c12"></a>
                                        <a href="<?php echo
                                        site_url('preferencie/delete/' . $preferencia['id_preferencie']); ?>"
